export const CURSE_CARDS = {
  ...
  false_accusation: { name: 'False Accusation', category: 'disrupt_aoe', costRatio: 0.45, limit: 'once_per_game' },
  mark_of_death: { name: 'Mark of Death', category: 'kill_tier', costRatio: 0.40 },
  curse_of_silence_council: { name: 'Curse of Silence Council', category: 'disrupt', costRatio: 0.50, limit: 'once_per_game' },
  soul_reap: { name: 'Soul Reap', category: 'kill_tier', costRatio: 0.65, limit: 'once_per_game' },
};
